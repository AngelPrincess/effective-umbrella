...
* Have your TAs refer to the [Time Tracker](23.3-TimeTracker.xlsx) to stay on track.
...
* Students are likely to be a bit overwhelmed by all the new syntax. Reassure them that this is natural, and that muscle memory comes with practice...Which the next activity will give them ample amounts of.
  ...
  * Zip and slack out the [Activities/2-Arrays-Maps-Conditions/Examples/collections](Activities/2-Arrays-Maps-Conditions/Examples/collections), and tell students to refer to them as they work through the activity.
...
* Zip and slack out the [solution](Activities/2-Arrays-Hashes-Conditions/Solved) before moving on.
...
* You'll have to add `static` after the access modifier for each function in the example file for it to compile.
  ...
  * For your convenience, there's a file in the same directory, [\_Functions.java](Activities/3-Functions/Examples/functions/Functions.java), in which this keyword is already present.
...
* Slack out the [solution](Activities/3-Functions/Solved) before moving on.
...
* Open up [your reference solution](Activities/4-Classes-and-Objects/Solved/console/Student.java), and check your students' solution against it.
...
* Slack out the [solution](Activities/4-Classes-and-Objects/Solved) before dismissing class.
