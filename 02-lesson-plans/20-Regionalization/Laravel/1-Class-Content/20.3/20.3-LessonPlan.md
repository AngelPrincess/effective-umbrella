...
* Have your TAs reference the [20.3-TimeTracker.xlsx](20.3-TimeTracker.xlsx) to keep track of time.
...
* The solutions to the review questions are in [0-Review/solutions.txt](Activities/0-Review/solutions.txt).
...
* Review the answers to these questions, and slack out [0-Review/solutions.txt](Activities/0-Review/solutions.txt) for student reference.
...
The finished files for this activity are in [2-User-Views/Solutions/Solutions](Activities/2-User-Views/Solutions). 
...
Solutions for this activity are in [3-Update-Users/Solutions](Activities/3-Update-Users/Solutions).
...
* The examples for this section are at [4-Snippets/Examples](Activities/4-Snippets/Examples).
...
The solutions to this activity are in [4-Snippets/Solutions](Activities/4-Snippets/Solutions).
