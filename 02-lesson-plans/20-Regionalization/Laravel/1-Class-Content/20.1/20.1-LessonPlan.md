...
* Be sure to tell students that they **must have PHP installed before coming to class**. Slack out the [PHP Installation Instructions](Supplements/PHP-Installation-Instructions.pdf) ahead of time.
...
* Have your TAs reference the [TimeTracker](20.1-TimeTracker.xlsx) to help keep track of time during class.
...
* Since someone will ask, PHP has stood for several things, but now means [PHP: Hypertext Processor](http://php.net/manual/en/history.php.php).
...
* Open up [1-Variables/Examples/example.php](Activities/1-Variables/Examples/example.php), and introduce students to how PHP declares variables.
...
* Open [2-Conditionals/Examples/example.php](Activities/2-Conditionals/Examples/example.php) to demonstrate.
...
* The solution to the previous activity is in [2-Conditionals/Solutions/solution.php](Activities/2-Conditionals/Solutions/solution.php).

* Take a moment to review the previous exercise, and slack out the solution.

* Open [3-Arrays/Examples/array_example.php](Activities/3-Arrays/Examples/array_example.php), and show students how to declare arrays.
...
* Open [3-Arrays/Examples/associative_array_example.php](Activities/3-Arrays/Examples/associative_array_example.php) and show students how to declare associative arrays.
...
* Finally, explain that PHP has a variable analogous to Node's `proces.argv`, which collects command-line arguments.
...
* **Instructions**
  ...
  * Create an associative array, and store your and your partner's last names as the keys, and your first names and age as the value. _Hint_: What data structure do you use to store mutiple pieces of information?
...
* Briefly review the solution to the activity: [3-Arrays/Solutions/solution.php](Activities/3-Arrays/Solutions/solution.php).
...
* Open [4-Functions/Examples/example.php](Activities/4-Functions/Examples/example.php).
...
* Finally, open [4-Functions/Examples/required.php](Activities/4-Functions/Examples/required.php) to demonstrate that PHP has a `require` statement, much like Node's `require` function.
...
The solution to this exercise is in [4-Functions/Solutions/solution.php](Activities/4-Functions/Solutions/solution.php) and [4-Functions/Solutions/helpers.php](Activities/4-Functions/Solutions/helpers.php).
...
* Open [5-Classes-and-Objects/Examples/Charizard_uncommented.php](Activities/5-Classes-and-Objects/Examples/Charizard_uncommented.php).
...
* Open [5-Classes-and-Objects/Examples/example.php](Activities/5-Classes-and-Objects/Examples/example.php), and demonstrate:
...
* Finally, point out that it would be unwieldy to create a class for each Pokemon that exists.
  ...
  * Regardless, we have example code demonstrating the [Pokemon class](Activities/5-Classes-and-Objects/Examples/Pokemon.php) and [PHP's `extends` syntax](Activities/5-Classes-and-Objects/Examples/Charizard_subclass.php). Slack them out for curious students.
...
* Review the solution in [5-Classes-and-Objects/Solutions/User.php](Activities/5-Classes-and-Objects/Solutions/User.php). Call on different students to answer the following:
...
* Zip and slack out the [6-PHP-Templates/boilerplate](Activities/6-PHP-Templates/Boilerplate) files to students.

* Open [6-PHP-Templates/Examples/index.php](Activities/6-PHP-Templates/Examples/index.php), and show students that you can embed PHP in HTML.
...
* Ask a different student to explain thes`$_POST` superglobal.
...
The Coding Bootcamp © All Rights Reserved 2016
