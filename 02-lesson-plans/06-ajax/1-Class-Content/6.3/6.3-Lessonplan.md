...
* TAs should reference [6.3-TimeTracker](6.3-TimeTracker.xlsx) to help keep track of time during class.
...
* **File:**
  ...
  * [`01-cat-button-students.html`](Activities/01-CatButton/01-cat-button-students.html)

* **Instructions:**

  * Open the file [`01-cat-button-students.html`](Activities/01-CatButton/01-cat-button-students.html) in your browser. Then take a few moments to see what the application does.
...
* Open the file [`2-button-triggered-ajax-solution.html`](Activities/02-ButtonTriggeredAJAX/2-button-triggered-ajax-solution.html) in your browser. Show students that clicking any one of the buttons triggers a series of gifs by its author to emerge.

* Next slack out the following file and instructions to students

* **File:**

  * [`2-button-triggered-ajax-students.html`](Activities/02-ButtonTriggeredAJAX/2-button-triggered-ajax-students.html)
...
* Next open [`3-dynamic-elements-solution.html`](Activities/03-DynamicElements/3-dynamic-elements-solution.html) and demonstrate the application in the browser.
...
* **File:**
  ...
  * [`3-dynamic-elements-students.html`](Activities/03-DynamicElements/3-dynamic-elements-students.html)
...
* Open the file `4-pausing-gifs-solution.html` in your browser. Demonstrate that in this application you can start and pause the animation of each gif you click.

* Then slack out the following files and instructions to students.

* **Files:**

  * [`4-pausing-gifs-students.html`](Activities/04-PausingGifs/4-pausing-gifs-students.html)
...
* Open the [`4-pausing-gifs-solution.html`](Activities/04-PausingGifs/4-pausing-gifs-solution.html) file in Sublime and walk students through the solution.
...
* Finally, break students into groups of four (with two students from each section). Have students move next to each other in the classroom before break.
