## 22.2 Lesson Plan - Sorting Algorithms

### Overview

In this class, we will be introducing students to sorting algorithms. If time and student interest are appropriate, instructors are free to touch on [Lodash](Extras/22.2-Lodash-Extra.md). We will then be leaving them with the remainder of class to work on projects.
...
* This site is fantastic for getting visualizations of how the sorts work <http://visualgo.net/sorting.html#>. If you prefer, you can show students videos from this link immediately after each "sort" method is revealed. Otherwise, you can save it until the end and have students look at it then.
...
* [algorithmStarter.js](Activities/1-Selection-Sort/Examples/algorithmStarter.js)
...
* Open up [selectionSort.js](Activites/1-Selection-Sort/Solutions/selectionSort.js), and walk through its essential steps with students.
...
* Slack out [the link to Visual Go](http://visualgo.net/sorting.html#), and play the video for the "Select Sort".
...
* [Play the video for insertion sort](http://visualgo.net/sorting.html#).
...
* [algorithmStarter.js](Activities/2-Insertion-Sort/Examples/algorithmStarter.js)
...
* [Open the solution file](Activities/2-Insertion-Sort/Solutions/insertionSort.js), and walk students through the essential steps of insertion sort.
...
* Slack out the [Visual Go](http://visualgo.net/sorting.html#) link again, and have students watch the video for quick-sort.
...
* Demo the [quickSortExample.js](Activities/3-Quicksort/Solutions/quickSortExample.js) file in your terminal to illustrate how much faster quick-sort is when dealing with large amounts of data.
...
* Open up [quicksort_pseudo.md](Activities/3-Quicksort/Solutions/quicksort_pseudo.md), and review the code.
