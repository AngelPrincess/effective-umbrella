## 22.1 Lesson Plan - Basics of Algorithms
...
* Have your TAs refer to the [TimeTracker](22.1-TimeTracker.xlsx) to stay on task.
...
* Open up [linearSearch.js](Activities/1-Benchmark/Solutions/linearSearch.js).
...
* Open up [1-Benchmark/Examples/linearSearch.js](Activities/1-Benchmark/Examples/linearSearch.js), and briefly explain the points below.

![Major methods of Benchmark.js.](Images/6-benchmark.png)

_Major methods of Benchmark.js._

* Zip and Slack out [1-Benchmark](Activities/1-Benchmark), and instruct students to unzip the archive.
...
* Open up [binarySearch.js](Activities/2-Binary-Search/Examples/binarySearch.js), and walk students through its essential steps.
