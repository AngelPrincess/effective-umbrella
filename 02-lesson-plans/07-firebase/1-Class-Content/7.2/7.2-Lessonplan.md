...
* Have your TAs reference [7.2-TimeTracker](7.2-TimeTracker.xlsx) to help keep track of time during class.
...
* Open the code in [`1-instructor-do-clickbutton-fireconsole.html`](Activities/01-clickbutton/1-instructor-do-clickbutton-fireconsole.html) (Do NOT slack out this code yet).
...
* Slack out the code for [`1-instructor-do-clickbutton-fireconsole.html`](Activities/01-clickbutton/1-instructor-do-clickbutton-fireconsole.html).
...
* Open the file [`2-instructor-do-clickbutton-fullcomments.html`](Activities/02-clickbutton-complete/2-instructor-do-clickbutton-fullcomments.html). Run the application in the browser.
...
* Slack out the file [`2-instructor-do-clickbutton-nocomments.html`](Activities/02-clickbutton-complete/2-instructor-do-clickbutton-nocomments.html) (be sure to send the one WITHOUT comments). Then ask students to comment each of the lines of the code with what they think is happening on that line.
...
* Once the activity is complete, slack out the file [`2-instructor-do-clickbutton-fullcomments.html`](Activities/02-clickbutton-complete/2-instructor-do-clickbutton-fullcomments.html). Tell them to look over this throughout class and when they get home.

### 13. Students Do: ClickDown Counter (15 min)

* Open the solved file [`3-student-do-downbutton.html`](Activities/03-countdownbutton/SOLVED/3-student-do-downbutton.html) in your browser. Show how the final application should work (click down until 0).
...
* **Files**:
  ...
  * [`3-student-do-downbutton.html`](Activities/03-countdownbutton/3-student-do-downbutton.html) (unsolved)
  * [`logic.js`](Activities/03-countdownbutton/logic.js) (unsolved)
  * [`logicOption2.js`](Activities/03-countdownbutton/logicOption2.js) (unsolved).

* **Instructions**:

  * Using either [`logic.js`](Activities/03-countdownbutton/logic.js) (unsolved) (easier) or [`logicOption2.js`](Activities/03-countdownbutton/logicOption2.js) (harder), create the click down activity using a Firebase database to store the click data on the backend.
...
* Create a new Firebase app and then open [`4-instructor-do-more-properties.html`](Activities/04-moreproperties/4-instructor-do-more-properties.html). Switch the link in the code included to the url for the firebase database you just created.
...
* Demonstrate the [`5-recentuser-solved.html`](Activities/05-mostrecentuser/SOLVED/5-recentuser-solved.html) file in the browser. Show students that the most recent user is changing in real-time to replace the old content when new data is submitted.

* Then slack out the unsolved [`5-recentuser.html`](Activities/05-mostrecentuser/5-recentuser.html) to students to attempt to create a webpage that does the same. The finished product should save the newest user to a Firebase database and change the HTML.

### 17. Instructor Do: Discuss / Explain Most Recent User (8 min)

* Review the [`5-recentuser-solved.html`](Activities/05-mostrecentuser/SOLVED/5-recentuser-solved.html) activity. Again focus on the key aspects: the `on.("value")` to track changes, the `.set({})` to add data, etc...
...
* **Files**:
  ...
  * [`6-codersbay.html`](Activities/06-codersbay/6-codersbay.html) (unsolved)
  * [`logic.js`](Activities/06-codersbay/logic.js) (unsolved)
  * [`logicOption2.js`](Activities/06-codersbay/logicOption2.js) (unsolved)

* **Instructions**:

  * Using either [`logic.js`](Activities/06-codersbay/logic.js) (easier) or [`logicOption2.js`](Activities/06-codersbay/logicOption2.js) (harder) as a starting point, create the CodersBay app using a Firebase database to store data on the backend.
...
* Open the file [`7-countdown-presence.html`](Activities/07-intropresence/7-countdown-presence.html) in your browser. Create multiple instances of the page and point out how its keeping track of all the viewers visiting the page.
...
* **Files**:
  ...
  * [`8-codersbay-view.html`](Activities/08-codersbay-viewtracker/8-codersbay-view.html) (unsolved)
  * [`logic.js`](Activities/08-codersbay-viewtracker/logic.js) (unsolved)
