...
4. Make sure you have `<?php include_once("yourFileNameHere"); ?>` and `{}` for those files.
...
9. Alternatively, deploy your new portfolio using the `gh_pages` branch of your repository.
